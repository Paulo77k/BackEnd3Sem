...
namespace EvenPlus.WebAPI.BdContextEvent;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdComentarioEvento).HasName("PK__Comentar__4305A1F102A47485");
        ...
        {
            entity.HasKey(e => e.IdEvento).HasName("PK__Evento__034EFC042D343A0A");
        ...
        {
            entity.HasKey(e => e.IdInstituicao).HasName("PK__Institui__B771C0D827C3EC9C");
        ...
        {
            entity.HasKey(e => e.IdPresenca).HasName("PK__Presenca__50FB6F5D54813C99");
        ...
        {
            entity.HasKey(e => e.IdTipoEvento).HasName("PK__TipoEven__CDB3A3BE7538A0D0");
        ...
        {
            entity.HasKey(e => e.IdTipoUsuario).HasName("PK__TipoUsua__CA04062B02ABB144");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__5B65BF97DEA7FF4E");
